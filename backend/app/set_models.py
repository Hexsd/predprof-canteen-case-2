...
with context_manager() as db:
    ...
    set_products = [Product(name="Фарш", alergens="1", amount=6), Product(name="Макароны рожки", alergens="4", amount=34), Product(name="Сухофрукты", alergens="9", amount=32), Product(name="Лук", alergens="", amount=6), Product(name="Молоко", alergens="3", amount=28), Product(name="Хлопья сладкие", alergens="4#3", amount=29), Product(name="Чай черный в пакетиках", alergens="", amount=30)]
