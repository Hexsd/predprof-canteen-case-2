...
def get_stats(
    ...
    """
    Get admin statistics. If date is provided, get stats for that specific date
    """
    query_date = None
    if date_param:
        try:
